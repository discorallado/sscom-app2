...
class BillsRelationManager extends RelationManager
{
    ...
    return $table
      ...
      ->actions([
        ...
        Tables\Actions\Action::make('details')
          ...
          ->color('secondary')
          ->url(fn (Bill $record): string => route('filament.resources.manager/bills.view', $record)),
  ...
  // {
  //   return fn (Model $record): string => route('App\Filament\Resources\Manager\BillResource\Pages\VewBill', ['record' => $record]);
  // }
